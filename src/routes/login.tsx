...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background px-4">
      ...
      <div className="w-full max-w-md rounded-2xl border border-border bg-card p-8 glow-primary">
        ...
        {googleClientId && (
          <>
            ...
            <div className="flex w-full justify-center overflow-hidden rounded-md [&>div]:w-full [&>div>div]:!w-full">
              <GoogleLogin
